...
public class MealTestData {
    ...
    public static void assertMatch(List<MealTo> actual, Iterable<Meal> excepted) {
        assertThat(actual).usingElementComparatorIgnoringFields("excess").isEqualTo(excepted);
    }
}
